...
| [0016](0016-agentcordon-update-is-server-pinned-self-update.md) | `agentcordon update` is a server-pinned self-update that restarts the broker with its captured argv | Accepted | 2026-09-07 |
...
- **Shipping and operating:** 0010, 0016, 0011.
