    ...
    endpoints.push(EndpointDoc {
        ...
        request_body: Some(json!({
            ...
            "properties": {
                ...
                "allowed_url_pattern": { "type": "string", "description": "Optional URL pattern for proxy whitelisting (e.g., 'https://api.slack.com/*'). Auto-defaults to 'https://**.amazonaws.com/*' for AWS type; a leading '**' in the host stands for one or more DNS labels, a '*' for exactly one." },
